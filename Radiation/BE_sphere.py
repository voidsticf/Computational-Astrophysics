...
def BE_sphere(u, gamma=1.0001, m_solar=1., T_K=10., x_ratio=6.5, y_ratio=14.1, verbose=0):
    ...
    rho_frac = sp.exp(-psi)             # rho(r)/rho_central = exp(-psi)
    ...
    u.D[ii] = rho_0 / 500.         # lower density x500 outside 
    u.T = u.E*(u.gamma-1.0)/u.D    # set temeprature accordingly (increase by x500)
